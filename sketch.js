...
level1obs1=createSprite(level1item1.x+100,height-200)
level1obs1.addImage(level1obs1img)
level1obs1.scale=0.5
level1obs1.visible=false

level1obs2=createSprite((level1item2.x+100),height-200)
